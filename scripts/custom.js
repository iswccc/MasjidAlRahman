...
$(document).ready(function(){
    ...
    function init_template(){
		...
		$('.shareToTwitter').prop("href", "https://twitter.com/intent/tweet?text=Stay+up+to+date+with+everything+Masjid+Al-Rahman "+share_link)
		...
		$('.shareToMail').prop("href", "mailto:?body=Stay up to date with everything Masjid Al-Rahman " + share_link)
	}
